...
class Arena(metaclass=BaseSingleton):
    ...
    def start_game(self, player, enemy):
        """
        НАЧАЛО ИГРЫ -> None присваиваем экземпляру класса аттрибуты "игрок" и "противник"
    ...
    def _check_players_hp(self):
        ...
        проверка здоровья игрока и врага и возвращение результата строкой: может быть три результата:
        Игрок проиграл битву, Игрок выиграл битву, Ничья (у обоих здоровье 0) и сохраняем его в аттрибуте
        (self.battle_result). Если Здоровья игроков в порядке, то ничего не происходит
        """
    ...
    def _end_game(self):
        """
        КНОПКА ЗАВЕРШЕНИЕ ИГРЫ - > return result: str очищаем синглтон - self._instances = {}
        останавливаем игру (game_is_running) возвращаем результат
        """
        self._instances = {}
